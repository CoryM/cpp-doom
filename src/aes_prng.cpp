...
#define ls_box(x) \
    crypto_fl_tab[0][get_byte(x, 0)] ^ crypto_fl_tab[1][get_byte(x, 1)] ^ crypto_fl_tab[2][get_byte(x, 2)] ^ crypto_fl_tab[3][get_byte(x, 3)]
...
#define f_rn(bo, bi, n, k)                                                                                                                                                                                          \
    do                                                                                                                                                                                                              \
    {                                                                                                                                                                                                               \
        bo[n] = crypto_ft_tab[0][get_byte(bi[n], 0)] ^ crypto_ft_tab[1][get_byte(bi[(n + 1) & 3], 1)] ^ crypto_ft_tab[2][get_byte(bi[(n + 2) & 3], 2)] ^ crypto_ft_tab[3][get_byte(bi[(n + 3) & 3], 3)] ^ *(k + n); \
    } while (0)
...
#define f_rl(bo, bi, n, k)                                                                                                                                                                                          \
    do                                                                                                                                                                                                              \
    {                                                                                                                                                                                                               \
        bo[n] = crypto_fl_tab[0][get_byte(bi[n], 0)] ^ crypto_fl_tab[1][get_byte(bi[(n + 1) & 3], 1)] ^ crypto_fl_tab[2][get_byte(bi[(n + 2) & 3], 2)] ^ crypto_fl_tab[3][get_byte(bi[(n + 3) & 3], 3)] ^ *(k + n); \
    } while (0)
