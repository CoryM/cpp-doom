...
struct [[gnu::packed]] maplinedef_hexen_t {
    short v1;
    short v2;
    short flags;
    uint8_t  special;
...
struct [[gnu::packed]] mapsubsector_deepbsp_t {
...
struct [[gnu::packed]] mapsubsector_zdbsp_t {
...
struct [[gnu::packed]] mapseg_deepbsp_t {
    int            v1;
    int            v2;
...
struct [[gnu::packed]] mapseg_zdbsp_t {
    unsigned int   v1, v2;
    unsigned short linedef;
    unsigned char  side;
};
...
struct [[gnu::packed]] mapnode_deepbsp_t {
    short x;
    short y;
    short dx;
    short dy;
...
struct [[gnu::packed]] mapnode_zdbsp_t {
    short x;
    short y;
    short dx;
    short dy;
...
struct [[gnu::packed]] mapthing_hexen_t {
    short tid;
    short x;
    short y;
    short height;
