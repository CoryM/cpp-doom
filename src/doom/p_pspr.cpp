...
//
void A_WeaponReady(mobj_t *mobj [[maybe_unused]], player_t *player, pspdef_t *psp)
{
    statenum_t newstate;
    int        angle;
...
void A_CheckReload(mobj_t *mobj [[maybe_unused]],
    player_t *             player,
    pspdef_t *             psp [[maybe_unused]])
{
    if (!player) return; // [crispy] let pspr action pointers get called from mobj states
...
//
void A_Lower(mobj_t *mobj [[maybe_unused]],
    player_t *       player,
    pspdef_t *       psp)
{
    if (!player) return; // [crispy] let pspr action pointers get called from mobj states
...
// A_Raise
//
void A_Raise(mobj_t *mobj [[maybe_unused]],
    player_t *       player,
    pspdef_t *       psp)
{
    statenum_t newstate;
...
// A_GunFlash
//
void A_GunFlash(mobj_t *mobj [[maybe_unused]],
    player_t *          player,
    pspdef_t *          psp [[maybe_unused]])
{
    if (!player) return; // [crispy] let pspr action pointers get called from mobj states
...
// A_Punch
//
void A_Punch(mobj_t *mobj [[maybe_unused]],
    player_t *       player,
    pspdef_t *       psp [[maybe_unused]])
{
    angle_t angle;
...
// A_Saw
//
void A_Saw(mobj_t *mobj [[maybe_unused]],
    player_t *     player,
    pspdef_t *     psp [[maybe_unused]])
{
    angle_t angle;
...
// A_FireMissile
//
void A_FireMissile(mobj_t *mobj [[maybe_unused]],
    player_t *             player,
    pspdef_t *             psp [[maybe_unused]])
{
    if (!player) return; // [crispy] let pspr action pointers get called from mobj states
...
// A_FireBFG
//
void A_FireBFG(mobj_t *mobj [[maybe_unused]],
    player_t *         player,
    pspdef_t *         psp [[maybe_unused]])
{
    if (!player) return; // [crispy] let pspr action pointers get called from mobj states
...
// A_FirePlasma
//
void A_FirePlasma(mobj_t *mobj [[maybe_unused]],
    player_t *            player,
    pspdef_t *            psp [[maybe_unused]])
{
    if (!player) return; // [crispy] let pspr action pointers get called from mobj states
...
// A_FirePistol
//
void A_FirePistol(mobj_t *mobj [[maybe_unused]],
    player_t *            player,
    pspdef_t *            psp [[maybe_unused]])
{
    if (!player) return;                  // [crispy] let pspr action pointers get called from mobj states
...
// A_FireShotgun
//
void A_FireShotgun(mobj_t *mobj [[maybe_unused]],
    player_t *             player,
    pspdef_t *             psp [[maybe_unused]])
{
    int i;
...
// A_FireShotgun2
//
void A_FireShotgun2(mobj_t *mobj [[maybe_unused]],
    player_t *              player,
    pspdef_t *              psp [[maybe_unused]])
{
    int     i;
...
// A_FireCGun
//
void A_FireCGun(mobj_t *mobj [[maybe_unused]],
    player_t *          player,
    pspdef_t *          psp)
{
    if (!player) return;                  // [crispy] let pspr action pointers get called from mobj states
...
// ?
//
void A_Light0(mobj_t *mobj [[maybe_unused]], player_t *player, pspdef_t *psp [[maybe_unused]])
{
    if (!player) return; // [crispy] let pspr action pointers get called from mobj states
    player->extralight = 0;
}

void A_Light1(mobj_t *mobj [[maybe_unused]], player_t *player, pspdef_t *psp [[maybe_unused]])
{
    if (!player) return; // [crispy] let pspr action pointers get called from mobj states
    player->extralight = 1;
}

void A_Light2(mobj_t *mobj [[maybe_unused]], player_t *player, pspdef_t *psp [[maybe_unused]])
{
    if (!player) return; // [crispy] let pspr action pointers get called from mobj states
    player->extralight = 2;
}
...
// A_BFGsound
//
void A_BFGsound(mobj_t *mobj [[maybe_unused]],
    player_t *          player,
    pspdef_t *          psp [[maybe_unused]])
{
    if (!player) return;               // [crispy] let pspr action pointers get called from mobj states
