...
#include "../../utils/lump.hpp"   // State.
#include "../../utils/memory.hpp" // State.
...
void R_DrawColumn(void)
{
    ...
    if (dc_x >= SCREENWIDTH
        || dc_yl < 0
        || dc_yh >= SCREENHEIGHT)
        S_Error(fmt::format("R_DrawColumn: {} to {} at {}", dc_yl, dc_yh, dc_x));
#endif
...
void R_DrawFuzzColumn(void)
{
    ...
    {
        S_Error(fmt::format("R_DrawFuzzColumn: {} to {} at {}",
            dc_yl, dc_yh, dc_x));
    }
#endif
...
void R_DrawTranslatedColumn(void)
{
    ...
    if (dc_x >= SCREENWIDTH
        ...
        || dc_yh >= SCREENHEIGHT)
    {
        S_Error(fmt::format("R_DrawColumn: {} to {} at {}",
            dc_yl, dc_yh, dc_x));
    }
...
auto R_DrawSpan() -> void
{
    ...
    if (ds_x2 < ds_x1
        ...
        || ds_y > SCREENHEIGHT)
    {
        S_Error(fmt::format("R_DrawSpan: {} to {} at {}",
            ds_x1, ds_x2, ds_y));
    }
//	dscount++;
#endif
