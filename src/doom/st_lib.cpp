    ...
    boolean                     refresh)
{
    ...
    if (screenblocks < CRISPY_HUD || (automapactive && !crispy->automapoverlay && !to_bool(crispy->widescreen)))
    ...
    boolean                            refresh)
{
        ...
        && (bi->oldval != *bi->val || refresh))
    {
        ...
        else if (screenblocks < CRISPY_HUD || (automapactive && !crispy->automapoverlay && !to_bool(crispy->widescreen)))
            V_CopyRect(x, y - ST_Y, st_backing_screen, w, h, x, y);
