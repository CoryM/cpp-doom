...
void A_Lower(mobj_t *);
void A_Raise(mobj_t *);
void A_StaffAttackPL1(mobj_t *);
void A_ReFire(mobj_t *);
void A_StaffAttackPL2(mobj_t *);
void A_BeakReady(mobj_t *);
void A_BeakRaise(mobj_t *);
void A_BeakAttackPL1(mobj_t *);
void A_BeakAttackPL2(mobj_t *);
void A_GauntletAttack(mobj_t *);
void A_FireBlasterPL1(mobj_t *);
void A_FireBlasterPL2(mobj_t *);
void A_SpawnRippers(mobj_t *);
void A_FireMacePL1(mobj_t *);
void A_FireMacePL2(mobj_t *);
void A_MacePL1Check(mobj_t *);
void A_MaceBallImpact(mobj_t *);
void A_MaceBallImpact2(mobj_t *);
void A_DeathBallImpact(mobj_t *);
void A_FireSkullRodPL1(mobj_t *);
void A_FireSkullRodPL2(mobj_t *);
...
void A_FireGoldWandPL1(mobj_t *);
void A_FireGoldWandPL2(mobj_t *);
void A_FirePhoenixPL1(mobj_t *);
void A_InitPhoenixPL2(mobj_t *);
void A_FirePhoenixPL2(mobj_t *);
void A_ShutdownPhoenixPL2(mobj_t *);
void A_PhoenixPuff(mobj_t *);
void A_RemovedPhoenixFunc(mobj_t *);
void A_FlameEnd(mobj_t *);
void A_FloatPuff(mobj_t *);
void A_FireCrossbowPL1(mobj_t *);
void A_FireCrossbowPL2(mobj_t *);
