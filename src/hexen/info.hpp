...
typedef void (*actionf_mobj)(mobj_t *mo);
typedef void (*actionf_pp)(player_t *pl, pspdef_t *psp);


union actionf_t {
    actionf_v  acv; // [crispy] let pspr action pointers get called from mobj states
    actionf_mobj af_mobj;
    actionf_pp af_pp;
    
    actionf_t() : acv { nullptr } {};

    actionf_t(actionf_mobj f) : af_mobj { f } {};

    actionf_t(actionf_pp f) : af_pp { f } {};
