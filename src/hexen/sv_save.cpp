...
static void StreamIn_player_t(player_t *str)
{
    ...
    // pclass_t class;
    str->pclass = static_cast<pclass_t>(SV_ReadLong());
...
static void StreamIn_mobj_t(mobj_t *str)
{
    ...
    // position is set.
    str->bnext = reinterpret_cast<mobj_s *>(SV_ReadPtr());
    str->bnext = NULL;
    str->bprev = reinterpret_cast<mobj_s *>(SV_ReadPtr());
    str->bprev = NULL;
...
static void UnarchiveMobjs(void)
{
    ...
    TargetPlayerAddrs = z_malloc<mobj_t ***>(MAX_TARGET_PLAYERS * sizeof(mobj_t **), PU_STATIC, NULL);
    TargetPlayerCount = 0;
    MobjCount = SV_ReadLong();
    MobjList = z_malloc<mobj_t **>(MobjCount * sizeof(mobj_t *), PU_STATIC, NULL);
    for (i = 0; i < MobjCount; i++)
    {
        MobjList[i] = z_malloc<mobj_t *>(sizeof(mobj_t), PU_LEVEL, NULL);
    }
    for (i = 0; i < MobjCount; i++)
    {
        mobj = MobjList[i];
...
static thinkInfo_t ThinkerInfo[] = {
    {
     ...
     reinterpret_cast<void(*)()>(StreamOut_floormove_t),
     reinterpret_cast<void(*)()>(StreamIn_floormove_t),
     reinterpret_cast<void(*)()>(RestoreSSThinker),
     sizeof(floormove_t)
    },
    {
     TC_PLAT_RAISE,
     reinterpret_cast<think_t>(T_PlatRaise),
     reinterpret_cast<void(*)()>(StreamOut_plat_t),
     reinterpret_cast<void(*)()>(StreamIn_plat_t),
     reinterpret_cast<void(*)()>(RestorePlatRaise),
     sizeof(plat_t)
    },
    {
     TC_MOVE_CEILING,
     reinterpret_cast<think_t>(T_MoveCeiling),
     reinterpret_cast<void(*)()>(StreamOut_ceiling_t),
     reinterpret_cast<void(*)()>(StreamIn_ceiling_t),
     reinterpret_cast<void(*)()>(RestoreMoveCeiling),
     sizeof(ceiling_t)
    },
    {
     TC_LIGHT,
     reinterpret_cast<think_t>(T_Light),
     reinterpret_cast<void(*)()>(StreamOut_light_t),
     reinterpret_cast<void(*)()>(StreamIn_light_t),
    ...
    },
    {
     ...
     reinterpret_cast<void(*)()>(StreamOut_vldoor_t),
     reinterpret_cast<void(*)()>(StreamIn_vldoor_t),
     reinterpret_cast<void(*)()>(RestoreSSThinker),
     sizeof(vldoor_t)
    },
    {
     ...
     reinterpret_cast<void(*)()>(StreamOut_phase_t),
     reinterpret_cast<void(*)()>(StreamIn_phase_t),
     reinterpret_cast<void(*)()>(NULL),
     sizeof(phase_t)
    },
    {
     ...
     reinterpret_cast<void(*)()>(StreamOut_acs_t),
     reinterpret_cast<void(*)()>(StreamIn_acs_t),
     reinterpret_cast<void(*)()>(NULL),
     sizeof(acs_t)
    },
    {
     ...
     reinterpret_cast<void(*)()>(StreamOut_polyevent_t),
     reinterpret_cast<void(*)()>(StreamIn_polyevent_t),
     reinterpret_cast<void(*)()>(NULL),
     sizeof(polyevent_t)
    },
    {
     ...
     reinterpret_cast<void(*)()>(StreamOut_pillar_t),
     reinterpret_cast<void(*)()>(StreamIn_pillar_t),
     reinterpret_cast<void(*)()>(RestoreSSThinker),
     sizeof(pillar_t)
    },
    {
    ...
    },
    {
     ...
     reinterpret_cast<void(*)()>(StreamOut_polydoor_t),
     reinterpret_cast<void(*)()>(StreamIn_polydoor_t),
     reinterpret_cast<void(*)()>(NULL),
     sizeof(polydoor_t)
    },
    {
     ...
     reinterpret_cast<void(*)()>(StreamOut_floorWaggle_t),
     reinterpret_cast<void(*)()>(StreamIn_floorWaggle_t),
     reinterpret_cast<void(*)()>(RestoreSSThinker),
...
static void UnarchiveThinkers(void)
{
    ...
    while ((tClass = SV_ReadByte()) != TC_NULL)
    {
        for (info = ThinkerInfo; info->tClass != TC_NULL; info++)
        {
            ...
            {
                thinker = z_malloc<thinker_t *>(info->size, PU_LEVEL, NULL);
...
static void CopyFile(char *source_name, char *dest_name)
{
    ...
    {
        buffer = z_malloc<byte *>(file_length, PU_STATIC, NULL);
        Z_Free(buffer);
    }
    ...
    buffer = z_malloc<byte *>(BUFFER_CHUNK_SIZE, PU_STATIC, NULL);
