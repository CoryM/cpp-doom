...
bool        M_FileExists(const std::string_view file);
char *      M_FileCaseExists(const std::string_view file);
...
[[deprecated("use S_StringDuplicate switch to std::strings")]] char *      M_StringDuplicate(const std::string_view orig);
