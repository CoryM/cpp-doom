...
static void NET_CL_SendPacket(net_addr_t *addr [[maybe_unused]], net_packet_t *packet)
{
...
static void NET_CL_FreeAddress(net_addr_t *addr [[maybe_unused]])
{
}
...
static void NET_SV_SendPacket(net_addr_t *addr [[maybe_unused]], net_packet_t *packet)
{
...
static void NET_SV_AddrToString(net_addr_t *addr [[maybe_unused]], char *buffer, int buffer_len)
{
    M_snprintf(buffer, buffer_len, "local client");
}

static void NET_SV_FreeAddress(net_addr_t *addr [[maybe_unused]])
{
}
