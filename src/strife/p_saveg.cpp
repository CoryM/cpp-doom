...
void P_UnArchiveSpecials (void)
{
    ...
    while (1)
    {
        ...
        case tc_ceiling:
            saveg_read_pad();
            ceiling = z_malloc<ceiling_t *>(sizeof(*ceiling), PU_LEVEL, NULL);
        ...
        case tc_door:
            saveg_read_pad();
            door = z_malloc<vldoor_t *>(sizeof(*door), PU_LEVEL, NULL);
        ...
        case tc_slidingdoor:
            ...
            saveg_read_pad();
            slidedoor = z_malloc<slidedoor_t *>(sizeof(*slidedoor), PU_LEVEL, NULL);
